...
_SYSTEM_PROMPT = (
    ...
    "   (c) FABRICATE SKILL/TOOL NOT IN SOURCE OR IMPLY UNEARNED RESPONSIBILITY "
    "   (forbidden). If the JD asks for 'AWS' and the source says nothing about "
    "   cloud platforms, do not add AWS. If the JD asks for 'Python' and the source "
    "   says nothing about programming, do not add Python. This extends to implied "
    "   responsibility claims: if the JD says 'Manage the P&L of the engagement' "
    "   and the veteran managed budgets but did not have profit-and-loss "
    "   accountability, do not write 'managed P&L' — 'managed budget' or 'managed "
    "   program financials' is accurate; 'managed P&L' is a false promotion. "
    "   Budget management and P&L management are not the same thing, even though "
    "   the JD uses the narrower phrase. Mirror nouns that describe what the "
    "   veteran actually did; do not mirror nouns that describe additional "
    "   authority, accountability, or scope the veteran did not have. The closing "
    "   gap is surfaced to the user in the ATS FIT ASSESSMENT question, not "
    "   papered over in a bullet.\n\n"
    ...
    "false responsibility claim. 'Budget management' and 'program "
    "financials' are accurate mirrors; 'P&L management' is a scope stretch. "
    "R3(c) draws this line: mirror nouns that describe what the veteran "
    "did; do not mirror nouns that imply authority the veteran did not "
    "hold.\n\n"
